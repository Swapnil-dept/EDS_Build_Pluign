...
export const DIALOG_PRINCIPLES: DialogDesignPrinciple[] = [
  {
    id: 'naming-consistency',
    title: 'Component Naming System',
    description:
      'Design a versatile, well-defined naming system in collaboration with CMS authors. Core concept first, then variant/modifier. Use sorting codes (e.g., c02x, c01x) or alphabetical grouping to ensure consistent ordering in component lists.',
    rationale:
      'Consistent naming reduces author confusion, speeds discovery, and ensures components group together logically. Versioning (Teaser Large vs. Large Teaser) guarantees all "Teaser" variants appear together, not scattered alphabetically.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Keep dialogs simple and focused. Avoid visual clutter, excessive options, and over-parameterization. Use tabs for logical grouping by priority/frequency. Offload rarely-used settings to template policies or author-controlled hide/show.',
    rationale:
      'Simple dialogs improve author confidence, reduce entry errors, and accelerate content authoring. Overloaded dialogs create decision paralysis and slow down the CMS.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Use tabs to organize fields by logical concern (Properties, Styling, Advanced) and by priority/frequency. Primary tab = fields authors use 90% of the time.',
  ...
  },
  {
    ...
    description:
      'Offload component behavior configuration (allowed colors, heading levels, aspect ratios, smart crop settings) to template policies, not component dialogs. Set once per template, apply to all instances.',
    rationale:
      'Policies ensure consistency across a template, reduce author mistakes, and simplify dialogs. Admins control policy; authors choose from pre-approved options.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Use AEM Style System (predefined CSS classes) for switching themes, visual variations, and styling switches. Keep styling controls out of the component dialog.',
    rationale:
      'Style System decouples layout from presentation, prevents CSS conflicts, and empowers front-end teams to manage design consistency independently of authoring workflows.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Use Granite UI "foundation-toggleable" classes to dynamically show/hide tabs, field groups, or individual fields based on author selections. Keep interface clean by hiding irrelevant options.',
  ...
  },
  {
    ...
    description:
      'Avoid placing fields in the dialog that could be better handled via inline editing (text titles, short labels, basic formatting). Allow authors to edit in real-time on the page without opening a dialog.',
  ...
  },
  {
    ...
    description:
      'If a component dialog requires dozens of fields for structured, reusable data, recommend a content fragment instead. Component dialog contains only a path-picker to the fragment.',
  ...
  },
  {
    ...
    description:
      'Prioritize CoralUI 3 components (Coral.Switch, Coral.Radio, Coral.SelectList, Coral.TagList) to ensure consistency, reduce custom code, and maintain light/dark theme compatibility. Avoid outdated CoralUI versions or custom HTML controls in dialogs.',
    rationale:
      'CoralUI ensures accessibility, theme compliance (light/dark), and vendor consistency. Custom controls introduce technical debt and maintenance burden.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Provide a tooltip for every dialog field. Make tooltips concise yet thorough, explaining how to populate the field, boundary conditions, and limitations. Link to user manual via helpPath (circled ? icon in top-right).',
    rationale:
      'Good tooltips reduce support burden, prevent data entry errors, and allow authors to work without documentation. Help paths link to deeper content for complex components.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Use substance-first, noun-based field names. Avoid fluff, jargon, or redundancy. Label and property name should be clear, actionable, and consistent across all components.',
  ...
  },
  {
    ...
    description:
      'Apply validation wherever a value may go out of bounds. Explain boundaries in the tooltip. Provide explicit defaultValue properties for critical fields. Use CoralUI validation patterns.',
    rationale:
      'Validation prevents invalid data entry and guides authors toward correct inputs. Defaults reduce author effort and ensure sensible starting points.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Choose the right option model based on scope and lifecycle. Fixed, untranslatable, unchanging lists → Coral.SelectList. Dynamic, translatable, frequently-changing, or reused options → AEM Tag Taxonomy with Coral.TagList.',
    rationale:
      'Correct modeling prevents maintenance burden, supports internationalization, and allows non-developers to manage options.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Pre-set initial content paths (rootPath) for each path-picker field and pre-filter selections if possible. Prevents authors from navigating the entire AEM repository and accelerates authoring.',
  ...
  },
  {
    ...
    description:
      'Design dialogs for AEM as a Cloud Service. Ensure compatibility with SDK, avoid deprecated patterns, follow Cloud-specific validation rules, and test in Cloud Preview environment.',
...
// ─── Dialog Field Types & Best Practices ───────────────────────────────────────
...
export const DIALOG_FIELD_TYPES: DialogFieldType[] = [
  {
    id: 'switch-toggle',
...
export const NAMING_CONVENTIONS = {
  ...
  componentNamingPattern: {
    ...
    rationale:
      'Alphabetical grouping: all teasers together under "T", then subcategories under each.',
  },
  fieldNamingPattern: {
