...
const SKILLS = [
  {
    ...
    description:
      'Breaks down tasks, guides phased delivery, and keeps development on track before any code is written.',
  },
  {
    name: 'Researcher',
    description:
      'Looks up drop-in component APIs, slot names, event payloads, and TypeScript definitions before implementing.',
  },
  {
    name: 'Block developer',
    description:
      'Builds and customizes Edge Delivery Services blocks using correct DOM patterns and CSS scoping.',
  },
  {
    name: 'Drop-in developer',
    description:
      'Customizes drop-in components using containers, slots, events, and API functions.',
  },
  {
    name: 'Content modeler',
    description:
      'Designs block table structures that are easy for content authors to work with.',
  },
  {
    name: 'Tester',
    description:
      'Verifies implementations in a real browser and checks Core Web Vitals and accessibility.',
  },
];
  ...
  server.tool(
    ...
    async ({ agent, section = 'all' }) => {
      ...
      if (section === 'all' || section === 'overview') {
        parts.push(
          `# Adobe Commerce AI Agent Skills Setup\n\n` +
