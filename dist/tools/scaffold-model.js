...
export function registerScaffoldModel(server) {
    server.tool('scaffold_model', `Generate Universal Editor component model files for an EDS block. Creates entries for component-models.json (field definitions), component-definitions.json (block registration), and component-filters.json (allowed children). These files go in your project root and enable authoring in AEM Universal Editor.`, {
