...
export function registerValidateBlock(server) {
    server.tool('validate_block', 'Validate an AEM EDS block against coding standards and best practices. Checks JS, CSS, JSON model, and sample content. Returns errors, warnings, and suggested fixes.', {
        ...
        const summary = `${blockName}: ${result.errors.length} error(s), ` +
...
//# sourceMappingURL=validate-block.js.map