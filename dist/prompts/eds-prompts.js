...
const PROJECT_SUMMARY_WORKFLOW = '**FIRST-TRIGGER GATE.** Before any other tool call in this session, check whether `.project-summary.md` (or `PROJECT_SUMMARY.md`) exists at the workspace root. ' +
