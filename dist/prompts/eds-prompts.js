...
export function registerPrompts(server) {
    // ─── New Block Prompt ───────────────────────────────────
    server.prompt('new-block', 'Step-by-step guide for creating a new EDS block from scratch', {
        ...
        messages: [
            {
                ...
                content: {
                    type: 'text',
                    text: `Create an AEM EDS block named "${blockName}" that ${description}.\n\n` +
                        `Requirements:\n` +
    ...
    server.prompt('design-to-block', 'Turn a text description, a design screenshot, and/or a Figma URL into an EDS block using Adobe\'s Content-Driven-Development workflow', {
